 ...
 */
.directive('gPlacesAutocomplete', ['$parse', '$compile', '$timeout', '$document', 'googlePlacesApi',
        ...
        return {
            ...
            link: function($scope, element, attrs, controller) {
                ...
                function addClearButton() {
                    var btnClear = angular.element('<i ng-show="query.length > 0"></i>');
                    btnClear.attr('class', 'icon ion-close');
                    btnClear.attr('style', 'margin-right: 11px');
